...
export function SiteHeader({
  ...
  return (
    <header className="site-header">
      ...
      <button className="cart-button" type="button" onClick={onOpenCart} aria-label={`เปิดตะกร้า มีสินค้า ${cartCount} ชิ้น`} aria-haspopup="dialog" aria-controls="cart-dialog">
